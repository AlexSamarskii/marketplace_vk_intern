...
// Source: github.com/AlexSamarskii/marketplace_vk_intern/internal/repository (interfaces: SessionRepository)
//
// Generated by this command:
//
//	mockgen -package mock -destination internal/repository/mock/mock_session.go github.com/AlexSamarskii/marketplace_vk_intern/internal/repository SessionRepository
//
...
func (m *MockSessionRepository) CreateSession(ctx context.Context, userID int) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockSessionRepository) DeleteAllSessions(ctx context.Context, userID int) error {
	m.ctrl.T.Helper()
...
func (mr *MockSessionRepositoryMockRecorder) DeleteAllSessions(ctx, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteAllSessions", reflect.TypeOf((*MockSessionRepository)(nil).DeleteAllSessions), ctx, userID)
}
...
func (m *MockSessionRepository) GetSession(ctx context.Context, sessionToken string) (int, error) {
	m.ctrl.T.Helper()
